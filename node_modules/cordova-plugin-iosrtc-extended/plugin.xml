...
<plugin xmlns="http://apache.org/cordova/ns/plugins/1.0"
	...
	<platform name="ios">
		...
		<header-file src="src/webrtc-headers/RTCFieldTrials.h" />
		<header-file src="src/webrtc-headers/RTCMediaStreamTrack.h" />
		<header-file src="src/webrtc-headers/RTCSessionDescription.h" />
		<header-file src="src/webrtc-headers/RTCAudioSession.h" />
		<header-file src="src/webrtc-headers/RTCFileLogger.h" />
		<header-file src="src/webrtc-headers/RTCMetrics.h" />
		<header-file src="src/webrtc-headers/RTCTracing.h" />
		<header-file src="src/webrtc-headers/RTCAudioSessionConfiguration.h" />
		<header-file src="src/webrtc-headers/RTCICECandidate.h" />
		<header-file src="src/webrtc-headers/RTCMetricsSampleInfo.h" />
		...
		<header-file src="src/webrtc-headers/RTCVideoFrame.h" />
		<header-file src="src/webrtc-headers/RTCAudioTrack.h" />
		<header-file src="src/webrtc-headers/RTCLegacyStatsReport.h" />
		<header-file src="src/webrtc-headers/RTCPeerConnection.h" />
		<header-file src="src/webrtc-headers/RTCVideoRenderer.h" />
		<header-file src="src/webrtc-headers/RTCCameraPreviewView.h" />
		...
		<header-file src="src/webrtc-headers/RTCCameraVideoCapturer.h" />
		<header-file src="src/webrtc-headers/RTCMTLNSVideoView.h" />
		<header-file src="src/webrtc-headers/RTCRtpCodecParameters.h" />
		<header-file src="src/webrtc-headers/RTCVideoTrack.h" />
		<header-file src="src/webrtc-headers/RTCConfiguration.h" />
		<header-file src="src/webrtc-headers/RTCMTLVideoView.h" />
		<header-file src="src/webrtc-headers/RTCRtpEncodingParameters.h" />
		<header-file src="src/webrtc-headers/RTCVideoViewShading.h" />
		<header-file src="src/webrtc-headers/RTCDataChannel.h" />
		<header-file src="src/webrtc-headers/RTCMacros.h" />
		<header-file src="src/webrtc-headers/RTCRtpParameters.h" />
		<header-file src="src/webrtc-headers/UIDevice+RTCDevice.h" />
		<header-file src="src/webrtc-headers/RTCDataChannelConfiguration.h" />
		<header-file src="src/webrtc-headers/RTCMediaConstraints.h" />
		<header-file src="src/webrtc-headers/RTCRtpReceiver.h" />
		<header-file src="src/webrtc-headers/WebRTC.h" />
		<header-file src="src/webrtc-headers/RTCDispatcher.h" />
		<header-file src="src/webrtc-headers/RTCMediaSource.h" />
		<header-file src="src/webrtc-headers/RTCRtpSender.h" />
		<header-file src="src/webrtc-headers/RTCEAGLVideoView.h" />
		<header-file src="src/webrtc-headers/RTCMediaStream.h" />
		<header-file src="src/webrtc-headers/RTCSSLAdapter.h" />
